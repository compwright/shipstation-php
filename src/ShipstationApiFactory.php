...
class ShipstationApiFactory
{
     ...
     */
    public function legacyApi(string $apiKey, string $apiSecret, ?string $partnerApiKey = null): Api\LegacyApiCollection
    {
        if (!$apiKey || !$apiSecret) {
        ...
        return new Api\LegacyApiCollection(
            new ApiClient(
                $httpClient,
     ...
     */
    public function shippingApi(string $apiKey): Api\ShippingApiCollection
    {
        if (!$apiKey) {
        ...
        return new Api\ShippingApiCollection(
            new ApiClient(
                new Client([
